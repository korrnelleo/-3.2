...
function calcMessage(allMessages) {
  let editedMes = 0;
  ...
  console.log(
    `Общее количество сообщений: ${allMessages.length}, отредактировано: ${editedMes}, неотредактировано: ${allMessages.length - editedMes} `,
  );
  return;
}

calcMessage(allMessages);
